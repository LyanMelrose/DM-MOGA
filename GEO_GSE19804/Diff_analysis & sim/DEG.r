...
data<-read.table("E:/Personal_Data/zhuxuhui/GSE19804/GSE19804_Sanger_ENTREZ_ID",sep="\t",header=TRUE,row.names = 1)
...
write.table(up_gene,file ="D:/_Documents/_Papers/Paper_3/DATA/GEO/GEO_GSE19804/ENid_GSE19804_limma_UPgene.csv", sep=",", row.names = TRUE, col.names = TRUE, quote =FALSE)
write.table(down_gene,file ="D:/_Documents/_Papers/Paper_3/DATA/GEO/GEO_GSE19804/ENid_GSE19804_limma_DOWNgene.csv", sep=",", row.names = TRUE, col.names = TRUE, quote =FALSE)
up<-length(up_gene)
...
write.table(selected_genes,file ="E:/Personal_Data/zhuxuhui/GSE19804/ENid_GSE19804_limma_genes.csv", sep=",", row.names = TRUE, col.names = TRUE, quote =FALSE)
#导出差异表达的p值等指标
write.table(final[rownames(adj_pval_0.05_final),],file ="E:/Personal_Data/zhuxuhui/GSE19804/ENid_GSE19804_limma_genes_index.csv", sep=",", row.names = TRUE, col.names = TRUE, quote =FALSE)
...
write.table (sim,file ="E:/Personal_Data/zhuxuhui/GSE19804/ENid_GSE19804_sim.csv", sep=",", row.names = FALSE, col.names =FALSE, quote =FALSE)
write.table (remain_genes,file ="E:/Personal_Data/zhuxuhui/GSE19804/ENid_GSE19804_sim_genes.csv", sep=",", row.names = FALSE, col.names =FALSE, quote =FALSE)

#更改selected_genes为remain_genes在data中对应的数据
selected_genes<-data[remain_genes,]
write.table (selected_genes,file ="E:/Personal_Data/zhuxuhui/GSE19804/ENid_GSE19804_sim_genes_expression.csv", sep=",", row.names = TRUE, col.names = TRUE, quote =FALSE)
